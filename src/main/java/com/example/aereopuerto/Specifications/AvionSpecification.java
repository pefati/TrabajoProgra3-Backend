...
public class AvionSpecification {
    ...
    public static Specification<Avion> porModelo(String modelo) {
        return (root, query, criteriaBuilder) -> {
            if (modelo == null || modelo.trim().isEmpty()) return null;
            return criteriaBuilder.like(
    ...
    public static Specification<Avion> capacidadBodegaMinimaDesde(Float minimo) {
        return (root, query, criteriaBuilder) -> {
            if (minimo == null) return null;
    ...
    public static Specification<Avion> capacidadBodegaMaximaHasta(Float maximo) {
        return (root, query, criteriaBuilder) -> {
            if (maximo == null) return null;
